...
module.exports = {
	...
	"execute": async (message, [commandName]) => {
		...
		let helpEmbed = new MessageEmbed().setColor("PURPLE").setTitle("Help Command List").setDescription(`You can get more info about a command by doing \`${await message.guild.prefix}help [name/alias]\``);
